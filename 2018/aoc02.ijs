...
of suit that would let him fit through tight spaces like that. But, I heard that 
...
separately counting those with exactly three of any letter. You can multiply 
...
test_inputs=: 'abcdef','bababc','abbcde','abcccd','aabcdd','abcdee',:'ababab'
test_outputs=: 12
assert test_outputs = checksum test_inputs

input=: ];._2 freads '2018/aoc02_input.txt'
...
above, this is found by removing the differing character from 
...
test_outputs=: 'fgij'
assert test_outputs -: lettersInCommon test_inputs

'Day 2, Part 2 answer: %s' printf <lettersInCommon input
