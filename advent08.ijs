...
For example:
    ...
    "aaa\"aaa" is 10 characters of code, but the string itself contains six "a"
               characters and a single, escaped quote character, for a total of
...
echo 'Day08 Part1: ',": -/ +/ (#, [: # ('\\x[0123456789abcdefg]{2}';'"') rxrplc ('\\"';'"') rxrplc ('\\\\';'"') rxrplc }.@}:)&>  input
...
echo 'Day08 Part2: ',": -/ +/ (# ,~ [: # [: ('"' , ,&'"') ('\\';'^^') rxrplc ('"';'^"') rxrplc ])&>  input